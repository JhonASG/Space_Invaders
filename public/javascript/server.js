//gdBlBA.jPM7ow:GaGJx9XIfF8lawQPz-DzUJ0ysl1MsyE06q92oq-mJU0
...
let players = {};
let playerChannels = {};
let shipX = Math.floor((Math.random() * 1300 + 30) * 1000) / 1000;
...
const uniqueId = function () {
    return "id-" + totalPlayers + Math.random().toString(36).slice(2, 16);
};
...
realtime.connection.once("connected", () => {
    gameRoom = realtime.channels.get("game-room"); //Creando el canal del game room
    deadPlayerCh = realtime.channels.get("dead-player"); //Creando el canal del dead player
